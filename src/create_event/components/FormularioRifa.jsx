...
function FormularioRifa({ onFormSubmit, triggerAlert }) {
    // --- ESTADOS ---
            ...
            <div className="tickets-section">
                {tickets.map((ticket, index) => (
                    <div key={ticket.id} className="ticket-block">
                        <h4 className="ticket-section-title">Tipo de Boleto {index + 1}</h4>
                        <div className="form-grid">
            ...
            <div className="form-actions">
                ...
                <div className="buttons-left-group">
                    <button className="add-ticket-button" onClick={addTicketType}>
                        <span className="plus-icon">+</span> Añadir boleto
                    </button>

                    {/* NUEVO BOTÓN DE BORRAR */}
                    <button className="delete-ticket-button" onClick={removeTicketType}>
                        <span className="plus-icon">-</span> Borrar boleto
                    </button>
                </div>
